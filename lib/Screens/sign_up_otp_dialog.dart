...
class SignUpOTPDialog extends StatefulWidget {
  ...
  final String otp;
  SignUpOTPDialog(
      {this.mobileNumber, this.onVerified, this.onRetryClick, this.otp});

  @override
  _SignUpOTPDialogState createState() => _SignUpOTPDialogState();
}
